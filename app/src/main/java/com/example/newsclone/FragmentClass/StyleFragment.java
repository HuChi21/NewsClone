...
public class StyleFragment extends Fragment {
    ...
    private String category="Style";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.stylefrag,null);
        recyclerViewStyle=view.findViewById(R.id.recyclerviewstyle);
        modelClassArrayList = new ArrayList<>();
        recyclerViewStyle.setLayoutManager(new LinearLayoutManager(getContext()));
