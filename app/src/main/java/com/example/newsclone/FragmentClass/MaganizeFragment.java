...
public class MaganizeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.magazinefrag,null);
        recyclerViewMagazine=view.findViewById(R.id.recyclerviewmagazine);
        modelClassArrayList = new ArrayList<>();
        recyclerViewMagazine.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new Adapter(getContext(),modelClassArrayList);
        recyclerViewMagazine.setAdapter(adapter);
